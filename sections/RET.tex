...
\hline
	...
	\\
\hline
	\parbox[c][1.5cm]{1.2cm}{\input{tikz/RET/L.tex}} &
	L-Typ &
	\parbox[c][3cm]{5.3cm}{\input{tikz/RET/ReaktanzLTyp.tex}}&
	\begin{tabular}{cl}
	...
	\\
\hline
	\parbox[c][1.5cm]{1.2cm}{\input{tikz/RET/C.tex}} &
	C-Typ &
	\parbox[c][3cm]{5.3cm}{\input{tikz/RET/ReaktanzCTyp.tex}} &
	\begin{tabular}{cl}
	  $\underline{Z}(p)$&
	...
	\\
\hline
	\parbox[c][1.5cm]{1.2cm}{\input{tikz/RET/LCSer.tex}} &
	S-Typ &
	\parbox[c][3cm]{5.3cm}{\input{tikz/RET/ReaktanzSTyp.tex}} &
	\begin{tabular}{cl}
	  $\underline{Z}(p)$&
	...
	\\
\hline
	\parbox[c][1.5cm]{1.2cm}{\input{tikz/RET/LCPar.tex}} &
	P-Typ &
	\parbox[c][3cm]{5.3cm}{\input{tikz/RET/ReaktanzPTyp.tex}} &
	\begin{tabular}{cl}
	  $\underline{Z}(p)$&
...
\subsubsection{Mittels Partialbruchzerlegung}
	...
	\input{tikz/RET/PartialbruchImpedanz}\\
	Admittanzfunktion $Y(p)$\\
	\input{tikz/RET/PartialbruchAddmitanz}\\
...
\end{enumerate}
Impedanzfunktion $Z(p)$\\
\input{tikz/RET/KettenbruchImpedanz}\\
Admittanzfunktion $Y(p)$\\
\input{tikz/RET/KettenbruchAdmittanz}\\
\end{multicols}
