	...
	\begin{enumerate}
	  ...
	  \quad\frac{8p^4+48p^2+48}{3p^5+21p^3+30p}=\frac{A}{3p}+\frac{Bp}{p^2+2}+\frac{Cp}{p^2+5}$
		...
		\item Schaltung aufzeichnen:\\
			...
			\hspace*{0.5cm}\scalebox{0.6}{\input{tikzPictures/RET/PartialbruchImpedanz}}\\
			Admittanzfunktion $\underline{Y}(p)$\\
			\hspace*{0.5cm}\scalebox{0.55}{\input{tikzPictures/RET/PartialbruchAddmitanz}}	  
	\end{enumerate}
...
\begin{enumerate}
	...
	\item Schaltung aufzeichnen  (bei 2. Art L und C vertauschen):\\
		Impedanzfunktion $\underline{Z}(p)$\\
		\hspace*{0.5cm}\scalebox{0.6}{\input{tikzPictures/RET/KettenbruchImpedanz}}\\
		Admittanzfunktion $\underline{Y}(p)$\\
		\hspace*{0.5cm}\scalebox{0.6}{\input{tikzPictures/RET/KettenbruchAdmittanz}}\\
\end{enumerate}
