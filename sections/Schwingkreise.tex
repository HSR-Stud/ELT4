...
\begin{tabular}{| p{4cm} | p{7cm} | p{7cm} |}
	...
	\hline
	& & \\
	& \input{tikz/ParallelSKbeschriftet}
	& \input{tikz/SerieSK}\\
	\hline	
	DGL &
   ...
   \hline
   	...
   	&
		\multicolumn{3}{|l|}{
			...
			\input{tikz/BandbreiteVerstimmung}
			\end{minipage}} &
		\multicolumn{3}{|l|}{
			\begin{minipage}[c]{6cm}
	...
	\hline
		Zeigerdiagramme &
		\multicolumn{2}{|l|}{\input{tikz/ZeigerdiagrammL}} &
		\multicolumn{2}{|l|}{\input{tikz/ZeigerdiagrammM}} &
		\multicolumn{2}{|l|}{\input{tikz/ZeigerdiagrammR}} \\
	\hline
\end{tabular}
