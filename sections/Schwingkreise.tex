...
% 		\textcolor{red}{\beta_i} t e^{- \omega_r t}$ \\ 
	...
	Periodisch, $ Q > \frac{1}{2}$
	  ...
	  & $u(t) = e^{-\frac{\omega_r}{2Q_p}t}(\textcolor{blue}{U_1}\cos(\omega_0 t)+\textcolor{blue}{U_2}\sin(\omega_0
	  t))$
	  & $i(t) = e^{-\frac{\omega_r}{2Q_s}t}(\textcolor{red}{I_1}\cos(\omega_0 t)+\textcolor{red}{I_2}\sin(\omega_0
	  t))$\\ \cline{2-3}
	  &
	  \multicolumn{2}{l|}{
	  $\dot{u}(t)=\left(-\frac{\omega_r}{2Q_p} \cdot e^{-\frac{\omega_r}{2Q_p}t} \cdot \left(\textcolor{blue}{U_1}\cos(\omega_0
	  t)+\textcolor{blue}{U_2}\sin(\omega_0
	  t)\right)\right)+e^{-\frac{\omega_r}{2Q_p}t}\cdot \left(-\textcolor{blue}{U_1}\omega_0\sin(\omega_0
	  t) + \textcolor{blue}{U_2}\omega_0\cos(\omega_0 t)\right)$ }\\
	  &
	  \multicolumn{2}{l|}{
	  $\dot{i}(t)=\left(-\frac{\omega_r}{2Q_s} \cdot e^{-\frac{\omega_r}{2Q_s}t} \cdot \left(\textcolor{red}{I_1}\cos(\omega_0
	  t)+\textcolor{red}{I_2}\sin(\omega_0
	  t)\right)\right)+e^{-\frac{\omega_r}{2Q_s}t} \cdot \left(-\textcolor{red}{I_1}\omega_0\sin(\omega_0
	  t) + \textcolor{red}{I_2}\omega_0\cos(\omega_0 t)\right)$ }\\ 	  \cline{2-3}
	  & $\dot{u}(t=0)=-\frac{\omega_r}{2Q_p}\textcolor{blue}{U_1}+\omega_0\textcolor{blue}{U_2} $ &
	  $\dot{i}(t=0)=-\frac{\omega_r}{2Q_p}\textcolor{red}{I_1}+\omega_0 \textcolor{red}{I_2}$ \\
...
% 					\textcolor{red}{I_2} e^{-\frac{\omega_r}{2 Q_S} t} \sin{\omega_0 t} $ \\
		...
		& $\textcolor{red}{I_1} =  \frac{U_0}{L \cdot \omega_0} \quad \textcolor{red}{I_2} = 0
