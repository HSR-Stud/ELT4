...
% 		\textcolor{red}{\beta_i} t e^{- \omega_r t}$ \\ 
	...
	Periodisch, $ Q > \frac{1}{2}$
	  ...
	  &
	  \multicolumn{2}{|l|}{
	  $\dot{u}(t)=\left(\left(-\frac{\omega_r}{2Q_p}\right)e^{-\frac{\omega_r}{2Q_p}t}\left(U_1\cos(\omega_0
	  t)+U_2\sin(\omega_0
	  t)\right)\right)+e^{-\frac{\omega_r}{2Q_p}t}\left(-U_1\sin(\omega_0
	  t)\omega_0 + U_2\cos(\omega_0 t)\omega_0\right)$ }\\
	  &
	  \multicolumn{2}{|l|}{
	  $\dot{i}(t)=\left(\left(-\frac{\omega_r}{2Q_s}\right)e^{-\frac{\omega_r}{2Q_s}t}\left(I_1\cos(\omega_0
	  t)+I_2\sin(\omega_0
	  t)\right)\right)+e^{-\frac{\omega_r}{2Q_s}t}\left(-I_1\sin(\omega_0
	  t)\omega_0 + I_2\cos(\omega_0 t)\omega_0\right)$ }\\
	  & $\dot{u}(t=0)=-\frac{\omega_r}{2Q_p}U_1+\omega_0U_2 $ &
	  $\dot{i}(t=0)=-\frac{\omega_r}{2Q_p}I_1+\omega_0I_2$ \\
