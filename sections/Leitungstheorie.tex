	...
	\subsubsection{Verlustbehaftete Leitungen}
		...
		\begin{tabular}{| p{6cm} | l |}
			...
			\hline
				...
				$\underline{r}_{Quelle}=\frac{\underline{Z}_{Quelle}-\underline{Z}_W}
				{\underline{Z}_{Quelle}+\underline{Z}_W}=\underline{r}_{Last}\cdot
        e^{-2\gamma l}$ \\
			\hline
				&
			...
			\hline  
			  \textbf{Reflexionsdämpfung}
			  & $a=-\ln|\underline{r}|\text{ Neper}=-20\cdot
			  \log|\underline{r}|\text{ dB}$\\
			\hline
