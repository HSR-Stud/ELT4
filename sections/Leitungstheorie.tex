...
\subsection{Kapazitätsbelag}
	...
	\begin{minipage}{6cm}
    	\begin{tabular}{ll}
	    	\includegraphics[width=3cm]{./images/LeitungenParallel.png}
			\includegraphics[width=3cm]{./images/LeitungenKapazitaeten.png} \\
			\includegraphics[width=5cm]{./images/LeitungenParallel2.png}
		\end{tabular}
	\end{minipage}
...
\subsection{Induktivitätsbelag}
	...
	\begin{minipage}{6cm}
    	\begin{tabular}{ll}
	    	\includegraphics[width=5cm]{./images/Induktivitaetsbelag.png}
		\end{tabular}
	\end{minipage}
...
%	\subsubsection{Eigenschaften}
		...
		\begin{tabular}{p{9cm}p{9cm}}
        	\begin{minipage}{8cm}
            	...
            	\includegraphics[height=2cm]{./images/VerlaufSpannungsbetrag.png}
            \end{minipage}
			&
			\begin{minipage}{8cm}
            	Spannungs- Strombetrag der offenen Leitung:\\
            	\includegraphics[height=2cm]{./images/VerlaufSpannungsbetragOffeneLtg.png}
            \end{minipage}
        \end{tabular}
...
% 	\includegraphics[height=3.5cm]{../El4/images/Leitungen_MFReflx_EnAP_SAP.png} \textbf{text folgt} \\
	\begin{tabular}{p{9cm}p{9cm}}
		\begin{minipage}{8cm}
			\includegraphics[width=8cm]{./images/Leitungen_MFReflx_EnAP_SnAP.png}
	    \end{minipage}
		&
		\begin{minipage}{9cm} 	    	
		...
		\\
		\begin{minipage}{8cm}  
			\includegraphics[height=4.1cm]{./images/Leitungen_MFReflx_EnAP_SnAP_RaumZeit.png}    	    
	    \end{minipage}
		&
		\begin{minipage}{8cm}
			\includegraphics[height=4.1cm]{./images/Leitungen_MFReflx_EnAP_SnAP_Eingangsspannung.png}      	
	    \end{minipage}
	\end{tabular}
